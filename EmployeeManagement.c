...
void addrecord() //*add record of employee*//
{
	system("cls");
	fseek(fp, 0, SEEK_END);
	char another = 'y';
...
void deleterecord() //*delete record of an employee*//
{
	system("cls");
	char empname[50];
	char another = 'y';
...
void displayrecord() //*display record of an employee*//
{
	system("cls");
...
void modifyrecord() //*modify record of an employee *//
{
	system("cls");
	char empname[50];
	char another = 'y';
